...
def main():
  ...
  plistpath = scriptpath + "/resources/TextField-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TextField-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TextField-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TextField-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TextField-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/TextField.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/TextField.iss",inplace=1):
