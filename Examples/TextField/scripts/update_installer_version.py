...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TextField Demo Installer\n"
      else:
        line="OutputBaseFilename=TextField Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TextField Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TextField installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TextField Demo installer\n"
     else:
       line="SetupWindowTitle=TextField installer\n"
