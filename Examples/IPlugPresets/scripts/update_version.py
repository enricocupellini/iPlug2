...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugPresets-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPresets-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPresets-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPresets-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPresets-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugPresets.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugPresets.iss",inplace=1):
