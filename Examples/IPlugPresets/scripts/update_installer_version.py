...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugPresets Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugPresets Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugPresets Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugPresets installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugPresets Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugPresets installer\n"
