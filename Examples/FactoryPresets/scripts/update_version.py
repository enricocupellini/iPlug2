...
def main():
  ...
  plistpath = scriptpath + "/resources/FactoryPresets-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FactoryPresets-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FactoryPresets-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FactoryPresets-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FactoryPresets-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/FactoryPresets.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FactoryPresets.iss",inplace=1):
