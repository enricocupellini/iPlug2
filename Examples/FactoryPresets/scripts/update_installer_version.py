...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FactoryPresets Demo Installer\n"
      else:
        line="OutputBaseFilename=FactoryPresets Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FactoryPresets Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FactoryPresets installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FactoryPresets Demo installer\n"
     else:
       line="SetupWindowTitle=FactoryPresets installer\n"
