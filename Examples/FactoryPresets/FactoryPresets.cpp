...
FactoryPresets::FactoryPresets(const InstanceInfo& info)
...
//    pGraphics->EnableLiveEdit(true);
    ...
    pGraphics->AttachControl(new ICaptionControl(sameCell().FracRectVertical(0.5, false).GetMidVPadded(10.f), kParamMode, IText(24.f, COLOR_BLACK), COLOR_BLUE, false));
...
#if IPLUG_DSP
void FactoryPresets::OnIdle()
{
  mScopeSender.TransmitData(*this);
  mMeterSender.TransmitData(*this);
}

void FactoryPresets::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
